...
export const completedProjects: ProjectCard[] = [
  {
    ...
    description: 'My personal portfolio site showcasing projects, experience, and updated resume downloads.',
    platform: 'Vercel',
    status: 'Live',
  ...
  },
  {
    ...
    description: 'End-to-end financial analytics platform with ETL workflows, KPI calculations, dynamic filters, and interactive reporting.',
    platform: 'Streamlit',
    status: 'Live',
    tags: ['Finance', 'ETL', 'Dashboard'],
    monogram: 'FD',
  ...
  },
  {
    ...
    description: 'Production KPI tracker for annotation accuracy, throughput, error rates, and SLA compliance with automated ETL ingestion.',
    platform: 'Streamlit',
    status: 'Live',
    tags: ['Operations', 'KPI Tracking', 'Analytics'],
    monogram: 'VD',
  ...
  },
  {
    section: 'live',
    category: 'Analytics & Dashboards',
    title: 'GRS Fantasy Park MIS Command Center',
    description: 'Multi-module MIS dashboard for revenue tracking, footfall analytics, forecasting, anomaly detection, and automated KPI reporting.',
    platform: 'Streamlit',
    status: 'Live',
    tags: ['MIS Dashboard', 'Forecasting', 'Analytics'],
    monogram: 'GR',
  ...
  },
  {
    ...
    description: 'Transformer-based NLP pipeline to extract structured key-value information from unstructured documents for downstream processing.',
    platform: 'Python + NLP',
    status: 'Source',
...
export const ongoingProjects: ProjectCard[] = [
  ...
  },
  {
    ...
    category: 'Analytics & Dashboards',
    title: 'Sutra',
    description: 'An ongoing analytics dashboard experiment currently available through the public dashboard route.',
    platform: 'Vercel',
    status: 'Ongoing',
