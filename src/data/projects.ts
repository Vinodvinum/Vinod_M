...
export const completedProjects: ProjectCard[] = [
  ...
  },
  {
    ...
    description: 'A Streamlit dashboard that turns Python and SQL analysis into revenue, profit, and trend views for decision-makers.',
    platform: 'Streamlit',
    status: 'Live',
  ...
  },
  {
    ...
    description: 'A dashboard for tracking computer vision experiments, model metrics, and dataset distribution in one view.',
    platform: 'Streamlit',
    status: 'Live',
  ...
  },
  {
    ...
    description: 'A public Streamlit dashboard that makes operational KPIs easier for stakeholders to monitor and review quickly.',
    platform: 'Streamlit',
    status: 'Live',
    tags: ['Dashboard', 'Streamlit', 'Analytics'],
    monogram: 'GR',
...
export const ongoingProjects: ProjectCard[] = [
  ...
  },
  {
    ...
    description: 'A back-office hub that combines task management, webhook triggers, and n8n automation into one system.',
